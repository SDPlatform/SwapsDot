...
import SDStakingRewards from '../build/SDStakingRewards.json'

chai.use(solidity)

describe('SDStakingRewards', () => {
  ...
  it('deploy cost', async () => {
    const stakingRewards = await deployContract(wallet, SDStakingRewards.json, [
      wallet.address,
